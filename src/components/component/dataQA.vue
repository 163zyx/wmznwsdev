        ...
        <div class="dfxx">
          ...
          <div class="dfxx-right">
            ...
            <p class="dfxx-right-content">
              我拥有人工智能语言模型和BI双重能力，可以分析需求，并用可视化图表解答您的问题，也可以根据图表总结业务结论。</p>
            ...
            <div v-if="!item.loading">
              <div class="dfquery">
                ...
                <div class="content" :class="'content-df'+ index"
                  ...
                  <div v-if="item.showChart" :id="`chart${index}`" style="width: 600px;height:400px;"></div>
      ...
      if (this.chatData.length > 0) {
        ...
        if (latestRes.hasOwnProperty('message')) {
          ...
          if (latestRes.status === 'finish') {
            ...
            let params = {
              question: item.query,
              answer: item.response + '&' + JSON.stringify(this.chart_data),
              chat_no: 1,
            }
