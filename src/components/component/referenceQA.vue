                          ...
                          if(containsBrackets(this.chatData[this.chatData.length -1].response)) {
                              ...
                              textList.forEach((item, index) => {
                                  ...
                                  if(item.includes('code')) {
                                      ...
                                      if(item.includes('&')) {
                                          this.chatData[this.chatData.length -1].response = this.chatData[this.chatData.length -1].response.replace(item, `<span class="ref_link" id=${item.split("+")[1].slice(0, -1)}>${item.charAt(1)}</span>`)
                                      } else {
                                          if(item.includes('+')) {
                                              ...
                                              if(reference && reference.hasOwnProperty('indic')) {
                                                  ...
                                                  console.log(indice)
                                                  this.chatData[this.chatData.length -1].response = this.chatData[this.chatData.length -1].response.replace(item, `<span class="ref_link" id=${item.split("+")[1].slice(0, -1)}&${indice}>${item.charAt(1)}</span>`)
                                              }
                                          }
                                      }
                                  }
